...
export default class MainLoader extends Scene {
    ...
    private addBackgroundImage() {
        ...
        this.BgImg = this.add.sprite(width / 2, height / 2, 'BackgroundNewLayer').setScale(2.5)
        this.logoImage = this.add.sprite(width/2, 420, 'logo').setScale(0.6)
        this.title = this.add.sprite(width/2, 530, "title").setScale(0.9);
